-- Yolink Profile Gender migration
...
create or replace function create_profile(
  ...
  p_years_exp int, p_background text, p_looking_for text, p_avatar_color text, p_avatar_image text, p_gender text
)
returns json
language plpgsql
security definer
...
declare
  ...
  v_code text;
begin
  insert into profiles (name, title, company, industry, years_exp, background, looking_for, avatar_color, avatar_image, gender)
